-- Database: `moviework`
CREATE DATABASE IF NOT EXISTS `moviework` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `moviework`;
...
DELIMITER ;
truncate tmp_genres;
select splitString(genres,'|') 
  from movie;
select count(distinct t.genre) 
  from tmp_genres t;
